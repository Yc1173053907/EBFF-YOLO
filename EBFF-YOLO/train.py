...
def train(hyp, opt, device, tb_writer=None):
    ...
    amp0 = False
    # init_seeds(2 + rank)
    set_seeds(1, deterministic=True) #zz add
...
if __name__ == '__main__':
    ...
    #############################
    # parser.add_argument('--weights', type=str, default='E:/project_zhangzhen/SuperYOLO-improve/runs/train/exp288/weights/best.pt', help='initial weights path')
    parser.add_argument('--weights', type=str, default='', help='initial weights path')
    parser.add_argument('--cfg', type=str,default='E:/project_zhangzhen/SuperYOLO-improve/datasets/VEDAI/CFG/yolov8_MF_C2fDBB.yaml', help='model.yaml path') #yolov5s
    parser.add_argument('--super', action='store_true', help='super resolution')
    parser.add_argument('--data', type=str,default='E:\project_zhangzhen\SuperYOLO-improve\datasets\VEDAI\CFG\SRvedai.yaml', help='data.yaml path')
